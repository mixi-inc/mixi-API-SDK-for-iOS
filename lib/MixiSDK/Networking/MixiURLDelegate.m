...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response {
    if ([self.delegate respondsToSelector:@selector(mixi:didReceiveResponse:)]) {
        isStopping = ![self.delegate mixi:self.mixi didReceiveResponse:(NSHTTPURLResponse *)response];
    }
    else {
        isStopping = NO;
    }
