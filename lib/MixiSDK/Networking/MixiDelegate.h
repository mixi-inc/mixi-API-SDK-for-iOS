...
/**
 * \brief API実行時のレスポンスを確認
 *
 * レスポンスのステータスコードやヘッダの値を確認して処理を継続するかどうかを指定できます。
 *
 * \param mixi mixiオブジェクト
 * \param response HTTPレスポンス
 * \return 処理を継続する場合はYES、停止する場合はNO
 */
- (BOOL)mixi:(Mixi*)mixi didReceiveResponse:(NSHTTPURLResponse*)response;
